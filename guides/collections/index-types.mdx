...
Note that the whole document are stored as is regardless of its existence in index configurations,
...
including object. `objectIndexConfig` should be specified in order to index the fields inside the object.
