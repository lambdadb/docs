...
Analyzer names are lowercase and case-sensitive. If supplied, `analyzers` must be a non-empty array of distinct supported names. See [Choose text analyzers](/guides/collections/choose-text-analyzers) before combining analyzers or migrating an existing field.
