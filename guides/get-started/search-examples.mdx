...
Get your **project API key** from [LambdaDB Cloud](https://app.lambdadb.ai): sign in at [app.lambdadb.ai](https://app.lambdadb.ai), open your project, and copy the **API key**, **base URL**, and **project name** from the console. This guide assumes the `cohere-wikipedia-en-100k` collection already exists in that project with `title`, `url`, `text`, and `vector` fields. For signup and project setup, see the [Quickstart](/guides/get-started/quickstart).
