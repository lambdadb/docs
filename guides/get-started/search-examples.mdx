...
**🔧 How it works:** Combines traditional full-text search with vector similarity using hybrid scoring strategies like Reciprocal Rank Fusion (`rrf`), L2 norm (`l2`), or Min-Max (`mm`) normalization—flexibly choosing the best fit for your use case.
