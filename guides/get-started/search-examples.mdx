...
Check out [this page](/guides/data/query-data#hybrid-query) for more details about hybrid query and scoring.
...
- **Apply for early access:** https://40td9f.share-na2.hsforms.com/2Ckykg-UgT1K1oqAtWG3zMQ

## **🤝 Support**

Need help with your implementation? Check out our:

- **API reference:** [Comprehensive documentation for developers](/api-reference/introduction)
- **Community forum:** [Get help from other developers](https://discord.gg/dnKm7WUHWg)