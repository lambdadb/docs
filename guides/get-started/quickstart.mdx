...
<Info>
  The Free plan includes monthly read, write, and storage usage at no cost. Add a payment method when you need Standard plan usage beyond the Free plan limits. See [Understanding costs](/guides/costs/understanding-costs).
</Info>
