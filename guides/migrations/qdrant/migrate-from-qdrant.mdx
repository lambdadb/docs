...
<CardGroup cols={1}>
  <Card title="Qdrant SDK compatibility" href="/guides/migrations/qdrant/qdrant-sdk-compatibility" icon="code">
...
Not sure how to map your Qdrant workload to LambdaDB? Email [support@lambdadb.ai](mailto:support@lambdadb.ai) or ask in the [LambdaDB community Slack](https://join.slack.com/t/lambdadbcommunity/shared_invite/zt-3sg7565zm-sCTW3odRkEQt~auWUVVsTw) for help with collection design, query compatibility, and migration next steps.

A brief description of your collection and point counts, vector types and dimensions, and the problem you want to solve is enough to start. If useful, include a sanitized query, filter, or CLI error so we can discuss the mapping in concrete terms.
