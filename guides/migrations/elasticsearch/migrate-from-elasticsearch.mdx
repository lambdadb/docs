...
Use LambdaDB Migration CLI `v0.1.6` or later with the current LambdaDB API. If your installed CLI does not show `lambdadb-migration elasticsearch --help`, install a newer release before following this guide.
