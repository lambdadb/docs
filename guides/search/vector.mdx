---
title: Vector query
description: Run k-nearest-neighbor vector search in LambdaDB. Specify query vectors or query text, set k, apply pre-filters, and combine multi-field vector queries.
---
