...
description: Search LambdaDB documents with query string syntax based on Apache Lucene. Supports terms, phrases, wildcards, boolean operators, and range queries.
---
