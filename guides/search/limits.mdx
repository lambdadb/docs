---
title: Query limits
description: Review LambdaDB query constraints including maximum result size, execution timeout, boolean clause limits, and sparse vector value caps per request.
---
