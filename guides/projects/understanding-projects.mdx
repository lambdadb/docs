...
An LambdaDB project belongs to an organization and contains a number of indexes.
Each project is associated with an API key.
In order to make calls to the index and data LambdaDB APIs, you must provide a valid API key for the relevant project.
