...
A search query, or query, is a request for information about data in LambdaDB indexes.
...
```python python
url = f"https://{base_url}/projects/{project_name}/indexes/{index_name}/query"
