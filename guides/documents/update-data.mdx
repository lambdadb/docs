---
title: Update data
description: Update existing documents in a LambdaDB collection by ID. Modify specific fields without replacing the entire document using SDK or REST API calls.
---
...
<CodeGroup>
  ...
  with LambdaDB(
      ...
      docs = [
          {"id": "33201222", "title": "LambdaDB", "text": "LambdaDB is the vector lake for AI memory ... "},
