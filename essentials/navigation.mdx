---
title: Navigation
description: Set up the sidebar navigation menu in Mintlify using the navigation field in mint.json. Organize pages into groups with support for nested sections.
icon: 'map'
---
