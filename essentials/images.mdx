...
description: Add images, videos, iframes, and other HTML elements to your Mintlify documentation pages. Supports markdown syntax and a 5 MB file size limit.
icon: 'image'
---
